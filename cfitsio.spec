...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597678905
...
cp %{_builddir}/cfitsio-3.49/License.txt %{buildroot}/usr/share/package-licenses/cfitsio/c287787ea3432b806844ccb7571d6b8e3cd4a7ef
%make_install

...
Source0  : https://heasarc.gsfc.nasa.gov/FTP/software/fitsio/c/cfitsio-4.0.0.tar.gz
...
%prep
%setup -q -n cfitsio-4.0.0
cd %{_builddir}/cfitsio-4.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632930975
...
cp %{_builddir}/cfitsio-4.0.0/License.txt %{buildroot}/usr/share/package-licenses/cfitsio/c287787ea3432b806844ccb7571d6b8e3cd4a7ef
%make_install
...
/usr/lib64/libcfitsio.so.9.4.0.0

...
Source0  : https://heasarc.gsfc.nasa.gov/FTP/software/fitsio/c/cfitsio-4.6.2.tar.gz
...
%prep
%setup -q -n cfitsio-4.6.2
cd %{_builddir}/cfitsio-4.6.2
pushd ..
cp -a cfitsio-4.6.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743172878
...
/usr/lib64/libcfitsio.so.10.4.6.2

...
Source0  : https://heasarc.gsfc.nasa.gov/FTP/software/fitsio/c/cfitsio-3.47.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583540518
...
cp %{_builddir}/cfitsio-3.47/License.txt %{buildroot}/usr/share/package-licenses/cfitsio/c287787ea3432b806844ccb7571d6b8e3cd4a7ef
%make_install
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libcfitsio.so.8
/usr/lib64/libcfitsio.so.8.3.47

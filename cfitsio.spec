...
Source0  : https://heasarc.gsfc.nasa.gov/FTP/software/fitsio/c/cfitsio-4.4.0.tar.gz
...
%prep
%setup -q -n cfitsio-4.4.0
cd %{_builddir}/cfitsio-4.4.0
pushd ..
cp -a cfitsio-4.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709598383
...
cp %{_builddir}/cfitsio-%{version}/licenses/NASA_Open_Source_Agreement_1.3.txt %{buildroot}/usr/share/package-licenses/cfitsio/b993ebd792f2bc8162fbe51fc70794797e0e6526 || :
export GOAMD64=v2
GOAMD64=v3
pushd ../buildavx2/
%make_install_v3
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libcfitsio.so.10.4.4.0
/usr/lib64/libcfitsio.so.10
/usr/lib64/libcfitsio.so.10.4.4.0

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/cfitsio/b993ebd792f2bc8162fbe51fc70794797e0e6526

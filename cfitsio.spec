...
Source0  : https://heasarc.gsfc.nasa.gov/FTP/software/fitsio/c/cfitsio-4.3.0.tar.gz
...
%prep
%setup -q -n cfitsio-4.3.0
cd %{_builddir}/cfitsio-4.3.0
pushd ..
cp -a cfitsio-4.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1690380931
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libcfitsio.so.10.4.3.0
/usr/lib64/libcfitsio.so.10
/usr/lib64/libcfitsio.so.10.4.3.0
